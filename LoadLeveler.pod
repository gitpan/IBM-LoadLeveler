...
=head1 SYNOPSIS
 ...
 ($rc,err_obj)=ll_modify(EXECUTION_FACTOR|CONSUMABLE_CPUS|CONSUMABLE_MEMORY|WCLIMIT_ADD_MIN|JOB_CLASS|ACCOUNT_NO,\$value,$job_step);
  ...
  $object = ll_get_objs( $query, LL_STARTED|LL_SCHEDD|LL_CM|LL_MASTER|\
...
This version has only been tested with LoadLeveler 3.1.0.16 under AIX 5.1 and 3.2.0 under AIX 5.2.
