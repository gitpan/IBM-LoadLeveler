...
=head1 SYNOPSIS
  ...
  $return = ll_set_request( $query,QUERY_ALL|QUERY_JOBID|QUERY_STEPID|\
	...
	QUERY_PROCID|QUERY_RESERVATION_ID, \@filter,ALL_DATA|Q_LINE|STATUS_LINE );
...
Note: CLASSES query is only available in version LoadLeveler 3.2 and above.
      RESERVATIONS requires LoadLevler 3.3+
...
<tr>
<td>	RESERVATIONS</td><td>	QUERY_ALL QUERY_USER QUERY_GROUP QUERY_HOST QUERY_RESERVATION_ID</td>
</tr>
</table>
<br>
...
<tr>
<td>	QUERY_RESERVATION_ID</td><td>	Array reference containing a list of reservation ids </td>
</tr>
