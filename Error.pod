...
Starting with version 1.0.6 the errObj is now being returned in the package globale B<$IBM::LoadLeveler::errObj> and not via the return.  The reasons for doing this are:
